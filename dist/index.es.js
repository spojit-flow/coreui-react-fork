...
var CTimePicker = forwardRef(function (_a, ref) {
    ...
    var _v = useState(convertTimeToDate(time)), date = _v[0], setDate = _v[1];
    var _w = useState(null), initialDate = _w[0], setInitialDate = _w[1];
    var _x = useState(valid !== null && valid !== void 0 ? valid : (invalid === true ? false : undefined)), isValid = _x[0], setIsValid = _x[1];
    var _y = useState(date ? getAmPm(new Date(date), locale) : 'am'), _ampm = _y[0], setAmPm = _y[1];
    var _z = useState(visible), _visible = _z[0], setVisible = _z[1];
    var _0 = useState({
        listOfHours: [],
        listOfMinutes: [],
        listOfSeconds: [],
...
var CVirtualScroller = forwardRef(function (_a, ref) {
    ...
    var _e = useState(React$1.Children.count(children)), itemsNumber = _e[0], setItemsNumber = _e[1];
...
var CTable = forwardRef(function (_a, ref) {
    ...
    var columnNames = useMemo(function () { return getColumnNames$1(columns, items); }, [columns, items]);
...
var CSidebar = forwardRef(function (_a, ref) {
    ...
    return (React$1.createElement(React$1.Fragment, null,
        ...
        typeof window !== 'undefined' &&
            mobile &&
            createPortal(React$1.createElement(CBackdrop, { className: "sidebar-backdrop", visible: _visible }), document.body)));
});
CSidebar.propTypes = {
    children: PropTypes$1.node,
    className: PropTypes$1.string,
